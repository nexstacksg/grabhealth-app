...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    if (membership) {
      const pointsToAdd = Math.floor((cartTotal * (1 - tierDiscount)) / 100) * 10
      if (pointsToAdd > 0) {
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-24">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{formatPrice((cartTotal * (1 - tierDiscount)) * 0.07)}</span>
                </div>
                ...
                <div className="flex justify-between font-bold text-lg">
                  <span>Total</span>
                  <span>{formatPrice((cartTotal * (1 - tierDiscount)) * 1.07)}</span>
                </div>
                ...
                {membership && (
                  <div className="mt-2 p-3 bg-emerald-50 rounded-md text-sm">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="font-medium text-emerald-700">Membership Benefits Applied</p>
