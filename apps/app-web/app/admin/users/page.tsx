  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2 search-filter-container p-3 mb-4">
        <h2 className="text-base font-medium text-gray-700">Users Management</h2>
        <Button onClick={fetchUsers} variant="outline" size="sm" className="h-8 text-sm px-2 py-0 w-full sm:w-auto">
                ...
                <TableRow key={user.id} className="hover:bg-gray-50">
                  ...
                  <TableCell className="py-2 px-3 align-middle">
                    ...
                    >
                      ...
                      <SelectContent className="text-sm min-w-[120px]" position="popper">
                        <SelectItem value="admin">Admin</SelectItem>
                        <SelectItem value="customer">Customer</SelectItem>
                        <SelectItem value="sales">Sales</SelectItem>
                        <SelectItem value="leader">Leader</SelectItem>
