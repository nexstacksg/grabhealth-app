      ...
      <section className="bg-gradient-to-r from-[#e6f7fa] to-[#c5edf3] py-10 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
            <div>
              <Badge className="mb-4 bg-[#c5edf3] text-[#0C99B4] hover:bg-[#9adde9]">Health First</Badge>
              ...
              <p className="text-base md:text-lg text-gray-600 mb-6 md:mb-8">
                Join our membership program for exclusive health benefits, discounts on products, lab services, and
                monthly free gifts.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                <Link href="/products" className="w-full sm:w-auto">
                  <Button size="lg" className="bg-[#0C99B4] hover:bg-[#0a7b91] w-full sm:w-auto">
                    Get Started <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <Button size="lg" variant="outline" className="border-[#0C99B4] text-[#0C99B4] hover:bg-[#e6f7fa] w-full sm:w-auto">
                  Learn More
                </Button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <Card className="border-none shadow-sm">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">Reliable priority service for members</p>
              </CardContent>
            </Card>
            <Card className="border-none shadow-sm">
              <CardContent className="pt-6">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover our most popular health products with exclusive member discounts.
            </p>
          </div>
          <FeaturedProducts />
        </div>
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-2 text-gray-900">Our Service Values</h2>
              <div className="w-14 md:w-16 h-1 bg-[#0C99B4] mb-4 md:mb-6"></div>
              <p className="text-sm md:text-base text-gray-600 mb-5 md:mb-6">
                The cornerstone of our establishment is making the benefits of exceptional medical services reach the
                public without discrimination. We strive to live up to this philosophy through our stellar values, that
                are the pillar of every service that we offer under the banner of our prestigious platform.
              </p>
              <Button className="bg-[#0C99B4] hover:bg-[#0a7b91] w-full sm:w-auto">Contact Us</Button>
            </div>
          </div>
        </div>
      </section>
