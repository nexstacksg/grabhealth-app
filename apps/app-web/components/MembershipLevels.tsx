  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
      ...
      <p className="text-gray-600 text-sm text-center max-w-3xl mx-auto mb-4">
        Our membership system rewards loyalty with increasing benefits. Earn
        points to progress through levels and unlock exclusive perks.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-100">
          ...
          <p className="text-gray-600 text-sm mb-3">
            Begin at Level 7 and earn points to advance through levels.
          </p>
          <div className="space-y-3">
            {[
              ...
              <div
                key={idx}
                className="flex items-center bg-white p-3 rounded-lg border border-gray-100"
              >
        ...
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
          ...
          <p className="text-gray-600 text-sm mb-3">
            Premium levels with exclusive discounts on products and services.
          </p>
          <div className="space-y-3">
            {[
              {
              ...
              <div
                key={idx}
                className={`bg-gradient-to-r ${tier.color} p-3 rounded-lg flex items-center`}
              >
                <div
                  className={`w-10 h-10 flex items-center justify-center rounded-full bg-white/30 ${tier.textColor} font-bold text-sm mr-3`}
                >
                  {tier.level}
                </div>
                <div>
                  <h4
                    className={`font-semibold text-sm ${idx === 2 ? 'text-white' : 'text-gray-800'}`}
                  >
                    Level {tier.level}
                  </h4>
                  <p
                    className={`text-sm ${idx === 2 ? 'text-purple-100' : 'text-purple-700'}`}
                  >
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              <span className="font-medium">Earning points:</span> 10 points per
              $100 spent. Automatic upgrades when reaching required points.
            </p>
          </div>
        </div>
      </div>
