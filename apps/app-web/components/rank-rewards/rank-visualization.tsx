...
export default function RankVisualization() {
                ...
                <>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {networkData.downlineMembers.slice(3).map((subMember) => (
                      ...
                      >
                        <div
                          className={`w-12 h-12 ${getRankColor(subMember.rank)} rounded-full flex items-center justify-center text-white font-bold mb-2`}
                        >
                          {subMember.name
                            .split(' ')
                            .map((n) => n[0])
  ...
  const renderRadialView = () => {
    ...
    return (
      <div
        className="relative h-[500px] w-full overflow-auto"
        style={{
          transform: `scale(${zoomLevel})`,
      ...
      <CardContent className="p-0">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="network" className="m-0">
                ...
                <div className="flex items-center gap-1.5 mr-2">
                  {[
                    ...
                    <div key={rank.label} className="flex items-center gap-1">
                      <div
                        className={`w-2 h-2 bg-${rank.color} rounded-full`}
                      ></div>
            ...
            <div
              className="border-b border-border/50 p-3 overflow-auto h-[350px]"
              ref={canvasRef}
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                ...
                <div className="bg-muted/50 p-3 rounded-lg border border-border/50">
                  ...
                  <p className="text-xl font-bold mt-1 text-indigo-600">
                    {networkStats.indirectReferrals}
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div className="flex items-center justify-between p-2 border rounded-md">
                    ...
                    <span className="text-sm font-medium">
                      {networkStats.totalSales}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2 border rounded-md">
                    <span className="text-xs">Team Sales</span>
                    <span className="text-sm font-medium">
                      {networkStats.teamSales}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2 border rounded-md">
                    <span className="text-xs">Commissions</span>
                    <span className="text-sm font-medium text-[#0C99B4]">
                      {networkStats.commissionEarned}
                    </span>
                  </div>
                </div>
