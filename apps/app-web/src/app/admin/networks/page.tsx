...
function renderDownlineMembers(
  users: NetworkUser[],
  page: number,
          ...
          <TableBody>
            {currentUsers.map((user) => (
              <TableRow key={user.id} className="hover:bg-gray-50">
                ...
                <TableCell className="py-2 px-3 align-middle capitalize">
                  {user.role}
                </TableCell>
                <TableCell className="py-2 px-3 align-middle">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (term === '') {
                        ...
                        const filtered = downlineUsers.filter(
                          (user) =>
                  ...
                  <div>
                    <Tabs defaultValue="all" className="w-full">
                      ...
                      <TabsContent value="level1" className="mt-0">
                        {renderDownlineMembers(
                          downlineUsers.filter((user) => user.level === 1),
                          level1Page,
                          setLevel1Page
                        )}
                      </TabsContent>
