...
export interface ApiAccountRequestAccountRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'account_requests';
  info: {
    description: 'User account change requests';
    displayName: 'Account Request';
    pluralName: 'account-requests';
    singularName: 'account-request';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    requestType: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isFreeCheckup: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
...
export interface ApiCommissionTierCommissionTier
  ...
  info: {
    description: 'Commission tier configuration for MLM levels';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    directCommissionRate: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
        ...
        number
      >;
    indirectCommissionRate: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
    ...
    > &
      Schema.Attribute.Private;
    pointsRate: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    publishedAt: Schema.Attribute.DateTime;
    tierLevel: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMax<
        {
...
export interface ApiCommissionCommission extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tracks commission payments and calculations';
  ...
  attributes: {
    ...
    recipient: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    recipientRole: Schema.Attribute.String;
    relationshipLevel: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 4;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'PENDING'>;
    type: Schema.Attribute.Enumeration<['DIRECT', 'INDIRECT']> &
      Schema.Attribute.Required &
...
export interface ApiEmailVerificationEmailVerification
  ...
  info: {
    description: 'Email verification codes for user authentication';
...
export interface ApiFreeCheckupClaimFreeCheckupClaim
  extends Struct.CollectionTypeSchema {
  collectionName: 'free_checkup_claims';
  info: {
    description: 'Free checkup vouchers claimed by users';
    displayName: 'Free Checkup Claim';
    pluralName: 'free-checkup-claims';
    singularName: 'free-checkup-claim';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    claimDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::free-checkup-claim.free-checkup-claim'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['ACTIVE', 'USED', 'EXPIRED']> &
      Schema.Attribute.DefaultTo<'ACTIVE'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usedBooking: Schema.Attribute.Relation<'oneToOne', 'api::booking.booking'>;
    user: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
...
export interface ApiGiftItemGiftItem extends Struct.CollectionTypeSchema {
  collectionName: 'gift_items';
  info: {
    description: 'Gift items available through the loyalty program';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    requiredPurchases: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMembershipTierMembershipTier
  extends Struct.CollectionTypeSchema {
  collectionName: 'membership_tiers';
  info: {
    description: 'Different membership tiers with pricing and benefits';
...
export interface ApiPartnerAvailabilityPartnerAvailability
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    partner: Schema.Attribute.Relation<'manyToOne', 'api::partner.partner'>;
    publishedAt: Schema.Attribute.DateTime;
    slotDuration: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<30>;
    startTime: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPartnerDaysOffPartnerDaysOff
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    recurringType: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    country: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Singapore'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    daysOff: Schema.Attribute.Relation<
      'oneToMany',
      'api::partner-days-off.partner-days-off'
    >;
    description: Schema.Attribute.Text;
...
export interface ApiProductCommissionTierProductCommissionTier
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_commission_tiers';
  info: {
    description: 'Commission tiers for products with rates and amounts for different roles';
    displayName: 'Product Commission Tier';
    pluralName: 'product-commission-tiers';
    singularName: 'product-commission-tier';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    leaderCommissionAmount: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    leaderCommissionRate: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 1;
          min: 0;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-commission-tier.product-commission-tier'
    > &
      Schema.Attribute.Private;
    managerCommissionAmount: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    managerCommissionRate: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 1;
          min: 0;
    ...
    publishedAt: Schema.Attribute.DateTime;
    salesCommissionAmount: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    salesCommissionRate: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 1;
          min: 0;
...
export interface ApiProductPricingProductPricing
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_pricings';
  info: {
    description: 'Product pricing information including PV value and various price points';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customerPrice: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    pvValue: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    travelPackagePrice: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Promotional discounts and offers';
...
export interface ApiUserMembershipUserMembership
  ...
  info: {
    description: 'User membership subscriptions and status';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    startDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['ACTIVE', 'INACTIVE', 'EXPIRED']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'ACTIVE'>;
...
export interface ApiUserPointUserPoint extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User loyalty points tracking';
...
export interface ApiUserRelationshipUserRelationship
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_relationships';
  info: {
    description: 'Tracks user relationships and hierarchy levels';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    upline: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    user: Schema.Attribute.Relation<
...
export interface ApiUserRoleTypeUserRoleType
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_role_types';
  info: {
    description: 'Types of user roles in the system';
    displayName: 'User Role Type';
    pluralName: 'user-role-types';
    singularName: 'user-role-type';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    commissionMultiplier: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-role-type.user-role-type'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVolumeBonusTierVolumeBonusTier
  extends Struct.CollectionTypeSchema {
  collectionName: 'volume_bonus_tiers';
  info: {
    description: 'Volume-based bonus tiers for commissions';
    displayName: 'Volume Bonus Tier';
    pluralName: 'volume-bonus-tiers';
    singularName: 'volume-bonus-tier';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    bonusPercentage: Schema.Attribute.Decimal & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::volume-bonus-tier.volume-bonus-tier'
    > &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    emailVerificationCode: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::account-request.account-request': ApiAccountRequestAccountRequest;
      ...
      'api::free-checkup-claim.free-checkup-claim': ApiFreeCheckupClaimFreeCheckupClaim;
      'api::gift-item.gift-item': ApiGiftItemGiftItem;
      ...
      'api::partner-days-off.partner-days-off': ApiPartnerDaysOffPartnerDaysOff;
      'api::partner.partner': ApiPartnerPartner;
      'api::product-commission-tier.product-commission-tier': ApiProductCommissionTierProductCommissionTier;
      'api::product-pricing.product-pricing': ApiProductPricingProductPricing;
      ...
      'api::user-relationship.user-relationship': ApiUserRelationshipUserRelationship;
      'api::user-role-type.user-role-type': ApiUserRoleTypeUserRoleType;
      'api::user-role.user-role': ApiUserRoleUserRole;
      'api::volume-bonus-tier.volume-bonus-tier': ApiVolumeBonusTierVolumeBonusTier;
