  ...
  try {
    ...
    const partners = await Promise.all([
      prisma.partner.create({
        data: {
          ...
          description: 'Premium healthcare facility offering comprehensive health screening services',
          ...
          totalReviews: 156,
          isActive: true,
          specializations: ['General Practice', 'Health Screening', 'Vaccination', 'Specialist Consultation'],
      ...
      prisma.partner.create({
        data: {
          ...
          description: 'Family-friendly clinic specializing in preventive care and wellness programs',
          ...
          imageUrl: 'https://images.unsplash.com/photo-1631563019676-0b10b9b14504?w=800',
          rating: 4.6,
          totalReviews: 98,
          isActive: true,
          specializations: ['Family Medicine', 'Pediatrics', 'Women\'s Health', 'Chronic Disease Management'],
          operatingHours: JSON.stringify({
      ...
      prisma.partner.create({
        data: {
          ...
          totalReviews: 234,
          isActive: true,
          specializations: ['Laboratory Services', 'Medical Imaging', 'Cardiac Screening', 'Cancer Screening'],
          operatingHours: JSON.stringify({
    ...
    const services = await Promise.all([
      ...
      prisma.service.create({
        data: {
          ...
          description: 'Comprehensive basic health check including blood tests, BMI, and vital signs',
          duration: 60,
          price: 120,
      ...
      prisma.service.create({
        data: {
          ...
          description: 'Advanced health screening with additional tests including cardiac and cancer markers',
          duration: 120,
          price: 380,
          category: 'Health Screening',
          isActive: true,
      ...
      prisma.service.create({
        data: {
          ...
          description: 'COVID-19 vaccination service with pre-vaccination consultation',
          duration: 30,
          price: 45,
      ...
      prisma.service.create({
        data: {
          ...
          description: 'Comprehensive health check for children including growth assessment',
          duration: 45,
          price: 85,
          category: 'Pediatrics',
          isActive: true,
      ...
      prisma.service.create({
        data: {
          ...
          description: 'Specialized health screening for women including pap smear and breast examination',
          duration: 90,
          price: 250,
      ...
      prisma.service.create({
        data: {
          ...
          description: 'Complete cardiac assessment including ECG, stress test, and echo',
          duration: 180,
          price: 680,
      ...
      prisma.service.create({
        data: {
          ...
          description: 'Premium health package for executives with comprehensive tests and consultation',
          duration: 240,
          price: 1580,
          category: 'Health Screening',
          isActive: true,
    ...
    if (users.length > 0) {
      ...
      for (let dayOffset = 0; dayOffset < 7; dayOffset++) {
        ...
        for (const partner of partners) {
          const partnerServices = services.filter(s => s.partnerId === partner.id);
          const numBookings = Math.floor(Math.random() * 2) + 2; // 2-3 bookings

          for (let i = 0; i < numBookings && i < users.length; i++) {
            const service = partnerServices[Math.floor(Math.random() * partnerServices.length)];
