...
import { IProductCreate, IProductUpdate, ProductSearchParams, ProductSearchResponse, ProductStatus } from '@app/shared-types';
    ...
    try {
      return await this.prisma.product.create({
        data: {
          ...
          price: data.price,
          discountEssential: data.discountEssential ?? 0.10,
    ...
    try {
      ...
      return await this.prisma.product.update({
        ...
        data: {
          ...
          ...(data.discountEssential !== undefined && { discountEssential: data.discountEssential }),
          ...(data.discountPremium !== undefined && { discountPremium: data.discountPremium }),
